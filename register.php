...
<?php
						...
						$sql="INSERT INTO register_info (name,password,truename,sex,birthdate,age,num,email,province,city,area,authority,picture,time) VALUES('{$name}','{$password}','{$truename}','{$sex}','{$birth}','{$age}','{$num}','{$email}','{$province}','{$city}','{$area}','{$authority}','http://localhost/YYT-master/mainpages/images/face.jpg',CURDATE())";

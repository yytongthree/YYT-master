...
$a=strtolower(fileext($_FILES['file']['name']));   //strtolower将所有字母转换成小写
//判断文件类型   
if(!in_array(strtolower(fileext($_FILES['file']['name'])),$type))   //in_array(search,array,type) 在array中搜寻search
 {   
 $text=implode(",",$type);   

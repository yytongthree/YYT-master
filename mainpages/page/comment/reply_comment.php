...
<body class="childrenBody">
    <form class="layui-form" name="form1" enctype="multipart/form-data" method="post" action="dispose_comment.php">
	...
	<script type="text/javascript" src="commentAdd.js"></script>
</body>
</html>
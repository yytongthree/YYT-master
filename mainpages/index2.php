...
?>
	<div class="layui-layout layui-layout-admin">
		...
		<div class="layui-side layui-bg-black">
			...
			<div class="navBar2 layui-side-scroll"></div>
		</div>
		<!-- 右侧内容 -->
			...
			<div class="layui-tab marg0" lay-filter="bodyTab">
				...
				<div class="layui-tab-content clildFrame">
					<div class="layui-tab-item layui-show">
						<iframe src="page/main2.html"></iframe>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="layui-footer footer">
			<p>copyright @2017 请叫我马哥 更多模板：<a href="http://www.mycodes.net/" target="_blank">源码之家</a>　　<a onclick="donation()" class="layui-btn layui-btn-danger layui-btn-small">捐赠作者</a></p>
		</div>
	</div>

	<!-- 锁屏 -->
	<div class="admin-header-lock" id="lock-box" style="display: none;">
		<div class="admin-header-lock-img"><img src="<?php echo $picture;?>"/></div>
		<div class="admin-header-lock-name" id="lockUserName"><?php echo $_SESSION['username'];?></div>
		<div class="input_btn">
	...
	<script type="text/javascript" src="js/leftNav2.js"></script>

...
<body class="main_body">
	<div class="layui-layout layui-layout-admin">
			...
			<div class="layui-main">
			    ...
			    <ul class="layui-nav top_menu">
			    	<li class="layui-nav-item showNotice" id="showNotice" pc>
						<a href="javascript:;"><i class="iconfont icon-gonggao"></i><cite>公告预览</cite></a>
					</li>
					...
					<li class="layui-nav-item" pc>
						...
						<dl class="layui-nav-child">
							...
							<dd><a href="../manage/managerexit.php"><i class="iconfont icon-loginout"></i><cite>退出</cite></a></dd>
						</dl>
					</li>
				</ul>
			</div>
		...
		<div class="layui-side layui-bg-black">
			...
			<div class="navBar4 layui-side-scroll"></div>
		</div>
		<!-- 右侧内容 -->
		<div class="layui-body layui-form">
			<div class="layui-tab marg0" lay-filter="bodyTab">
				<ul class="layui-tab-title top_tab">
					<li class="layui-this" lay-id=""><i class="iconfont icon-computer"></i> <cite>个人中心</cite></li>
				</ul>
				<div class="layui-tab-content clildFrame">
					<div class="layui-tab-item layui-show">
						<iframe src="page/main4.html"></iframe>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="layui-footer footer">
			<p>copyright @2017 请叫我马哥    <a href="http://www.mycodes.net/" target="_blank">源码之家</a>　　<a onclick="donation()" class="layui-btn layui-btn-danger l·ayui-btn-small">捐赠作者</a></p>
		</div>
	</div>
	...
	<script type="text/javascript" src="js/nav4.js"></script>
	<script type="text/javascript" src="js/leftNav4.js"></script>
